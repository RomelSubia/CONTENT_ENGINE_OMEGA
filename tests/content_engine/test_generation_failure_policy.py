...
from content_engine.content_generation_governance import build_generation_failure_report, validate_generation_failure_report

def test_failure_policy_fail_closed():
    report = build_generation_failure_report("X", "test")
    assert validate_generation_failure_report(report)["status"] == "PASS"
