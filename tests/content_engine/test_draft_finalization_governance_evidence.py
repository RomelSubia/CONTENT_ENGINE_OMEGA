...
from content_engine.content_draft_finalization_governance.evidence import validate_evidence
from content_engine.content_draft_finalization_governance.models import FinalizationEvidence

def test_evidence_validates():
    validate_evidence(valid_evidence())

def test_evidence_rejects_bad_hash():
    evidence = FinalizationEvidence(
        human_review_reference="human-review://ok",
        human_review_sha256="bad",
        human_review_manifest_reference="manifest://human-review",
        safe_preview_reference="safe-preview://ok",
        safe_preview_sha256=VALID_HASH,
        safe_preview_manifest_reference="manifest://safe-preview",
