...
from content_engine.content_generation_governance import require_human_review, validate_human_review_not_authorization

def test_human_review_required_is_not_authorization():
    assert require_human_review()["human_review_required"] is True
    assert require_human_review()["generation_allowed_now"] is False

def test_human_bypass_blocks():
    assert validate_human_review_not_authorization("sí autorizo generar")["status"] == "BLOCK"
